                ...
                <div class="row">
                  ...
                  <div class="col-sm-7">
                    <div class="form-group{{ $errors->has('hp') ? ' has-danger' : '' }}">
                      <input class="form-control{{ $errors->has('hp') ? ' is-invalid' : '' }}" name="hp" id="input-hp" type="phone" value="{{ old('email', auth()->user()->email) }}" required readonly/>
                      @if ($errors->has('hp'))
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('jk') ? ' has-danger' : '' }}">
                        <select class="form-control" class="form-control" name="jk" id="jk">
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('lama_hipertensiTahun') ? ' has-danger' : '' }} col-sm-2">
                        <input class="form-control{{ $errors->has('lama_hipertensiTahun') ? ' is-invalid' : '' }} " name="lama_hipertensiTahun" id="input-lama_hipertensiTahun" type="number" placeholder="{{ __('Tahun') }}" required />
                        <input class="form-control{{ $errors->has('lama_hipertensi') ? ' is-invalid' : '' }} " name="lama_hipertensi" id="input-lama_hipertensi" type="number" placeholder="{{ __('Bulan') }}" required />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('penyakit_lain') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('penyakit_lain') ? ' is-invalid' : '' }}" name="penyakit_lain" id="input-penyakit_lain" type="text" placeholder="{{ __('') }}" required />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('alasan') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('alasan') ? ' is-invalid' : '' }}" name="alasan" id="input-alasan" type="text" placeholder="{{ __('') }}" required />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('konsumsi_obat') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('konsumsi_obat') ? ' is-invalid' : '' }}" name="konsumsi_obat" id="input-konsumsi_obat" type="text" placeholder="{{ __('') }}" required />
                  ...
                  <div class="row">
                    ...
                    <div class="col-sm-7">
                      <div class="form-group{{ $errors->has('nama_tempat_berobat') ? ' has-danger' : '' }}">
                        <input class="form-control{{ $errors->has('nama_tempat_berobat') ? ' is-invalid' : '' }}" name="nama_tempat_berobat" id="input-nama_tempat_berobat" type="text" placeholder="{{ __('') }}" required />
