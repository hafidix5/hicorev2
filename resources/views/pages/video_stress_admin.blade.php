    ...
    <div class="card">
      <div class="card-header card-header-primary">
        ...
        <div class="col-md-12">
                    ...
                    <?php $no=1; ?>
                        ...
                        <tr>
                            ...
                            <td>
                                  ...
                                  <a class="nav-link" href="{{ route('video_stress.edit',$response->id)  }}">
                                    <i class="material-icons">verified_user </i> Edit
                                  </a>
                                 
                                   <a class="nav-link" href="{{ route('video_stress.destroy',$response->id) }}">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <a href="{{ url('video_stress.insert') }}" class="btn btn-xs btn-info pull-left ml-auto">Tambah</a>
                </div>
            </div>
