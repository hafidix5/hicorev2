    ...
    <div class="card">
      ...
      <iframe src="{{ asset('material') }}/img/silence.mp3" type="audio/mp3" allow="autoplay" id="audio" style="display: none"></iframe>
        <audio id="player" autoplay>
          <source src="{{ asset('material') }}/img/pengendalian_diri.mp3" type="audio/mp3">
      </audio>
        @if (session('status'))
        <div class="row">
          <div class="col-sm-12">
      ...
      @endif
        <div class="table-responsive">
          <table class="table table-hover">
            ...
            <tbody>
                <form method="post" action="{{ route('isi_pengendalianSave') }}" autocomplete="off" class="form-horizontal">
                    @csrf
                    @method('post')
            <?php $no=1; ?>
            <tr><td style="font-weight:bold;">Penggunaan Obat-obatan</td>
            </tr>
            @foreach ($pengendalian_1 as $pengendalian_1)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_1->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="-1" required/> Tidak diresepkan obat</span><br>
                        <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="0"/> 0</span>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="1"/> 1</span>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="2"/> 2</span><br>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="3"/> 3</span>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="4"/> 4</span>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="5"/> 5</span><br>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="6"/> 6</span>
                       <span><input type="radio" id={{ $pengendalian_1->id }} name={{ $pengendalian_1->id }} value="7"/> 7</span>
                   </div>
                    </td>
                </tr>
            @endforeach
            ...
            @foreach ($pengendalian_2 as $pengendalian_2)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_2->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="0" required/> 0</span>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="1"/> 1</span>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="2"/> 2</span><br>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="3"/> 3</span>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="4"/> 4</span>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="5"/> 5</span><br>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="6"/> 6</span>
                       <span><input type="radio" id={{ $pengendalian_2->id }} name={{ $pengendalian_2->id }} value="7"/> 7</span>
                   </div>
                    </td>
                </tr>
            @endforeach
            ...
            @foreach ($pengendalian_3 as $pengendalian_3)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_3->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="0" required/> 0</span>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="1"/> 1</span>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="2"/> 2</span><br>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="3"/> 3</span>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="4"/> 4</span>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="5"/> 5</span><br>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="6"/> 6</span>
                       <span><input type="radio" id={{ $pengendalian_3->id }} name={{ $pengendalian_3->id }} value="7"/> 7</span>
                   </div>
                    </td>
                </tr>
            @endforeach
            ...
            @foreach ($pengendalian_4 as $pengendalian_4)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_4->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="0" required/> 0</span>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="1"/> 1</span>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="2"/> 2</span><br>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="3"/> 3</span>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="4"/> 4</span>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="5"/> 5</span><br>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="6"/> 6</span>
                       <span><input type="radio" id={{ $pengendalian_4->id }} name={{ $pengendalian_4->id }} value="7"/> 7</span>
                   </div>
                    </td>
                </tr>
            @endforeach
            ...
            @foreach ($pengendalian_5 as $pengendalian_5)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_5->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_5->id }} name={{ $pengendalian_5->id }} value="0" required/> Sangat tidak setuju</span><br>
                       <span><input type="radio" id={{ $pengendalian_5->id }} name={{ $pengendalian_5->id }} value="1"/> Tidak setuju</span><br>
                       <span><input type="radio" id={{ $pengendalian_5->id }} name={{ $pengendalian_5->id }} value="2"/> Tidak Yakin</span><br>
                       <span><input type="radio" id={{ $pengendalian_5->id }} name={{ $pengendalian_5->id }} value="3"/> Setuju</span><br>
                       <span><input type="radio" id={{ $pengendalian_5->id }} name={{ $pengendalian_5->id }} value="4"/> Sangat Setuju</span>
                   </div>
                    </td>
                </tr>
            @endforeach

            @foreach ($pengendalian_6 as $pengendalian_6)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_6->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="0" required/> 0</span>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="1"/> 1</span>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="2"/> 2</span><br>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="3"/> 3</span>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="4"/> 4</span>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="5"/> 5</span><br>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="6"/> 6</span>
                       <span><input type="radio" id={{ $pengendalian_6->id }} name={{ $pengendalian_6->id }} value="7"/> 7</span>
                   </div>
                    </td>
                </tr>
            @endforeach
            @foreach ($pengendalian_7 as $pengendalian_7)

                <tr>
                    <td>{{ $no++ }}</td>
                    <td>{{ $pengendalian_7->pertanyaan }}</td>
                    <td class="text-left">
                        <span><input type="text" id={{ $pengendalian_7->id }} name={{ $pengendalian_7->id }} value="" required/> </span>
